function UniteCreatorParamsDialog(){
	...
	function getAllInputs(){
		...
		var objInputs = g_objWrapper.find("input,textarea,select,table").not(".unite_table_settings_wide");
	...
	function getCurrentInputs(){
		...
		var objInputsLeft = g_objLeftArea.find(selector).not(".unite_table_settings_wide");
		var objInputsRight =  objCurrentContent.find(selector).not(".unite_table_settings_wide");
