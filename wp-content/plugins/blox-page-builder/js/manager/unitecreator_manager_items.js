function UCManagerAdminItems(){	
	...
	function initItems(objManager){
		...
		jQuery("#uc_list_items").delegate("li","contextmenu", onItemContextMenu);
		
		//on wrapper context menu
		g_objField.bind("contextmenu", onFieldContextMenu);
		
		
		//on click
		jQuery("#uc_list_items").delegate("li", "click", onItemClick); 
		
		jQuery("#uc_list_items").delegate("li", "mousedown", function(event) {
		...
		jQuery("#uc_list_items").delegate("li", "mouseenter", function() {
			jQuery(this).addClass("item-hover");
			g_manager.triggerEvent(g_manager.events.ITEM_MOUSEOVER, jQuery(this));
		});
		
		//mouse out
		jQuery("#uc_list_items").delegate("li", "mouseleave", function() {
		...
		//double click
		jQuery("#uc_list_items").delegate("li", "dblclick", function() {
			g_manager.runItemAction("item_default_action");
		});
		
		//on items panel button click
		jQuery("#manager_buttons .uc-button-item").click(onItemsButtonClick);
	...
	function initItemsDragEvents(){
		...
		//on item mousedown
		jQuery("#uc_list_items").delegate("li","mousedown",onItemMouseDown);
	...
	this.destroy = function(){
		...
		//on item context menu
		$objListItems = jQuery("#uc_list_items li");
