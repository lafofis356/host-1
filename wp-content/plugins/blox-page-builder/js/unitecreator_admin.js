function UniteCreatorAdmin(){
	 ...
	 */
	function initParamPanelGlobals(arrChildKeys, initParamPanelGlobals,arrAddKeys){
	...
	this.initEditAddonView = function(){
		...
		//init param parnels
		initParamPanelGlobals(arrPanelChildKeys, arrPanelTemplateCode, arrPanelAddKeys);
