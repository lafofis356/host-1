...
function UniteSettingsUC(){
	...
	function getObjInputs(controlsOnly){
		...
		var selectorNot = "input[type='button'], input[type='range']";
	...
	function initAddonPicker(objInput){
		...
		objSelectButton.click(function(event){
	...
	function initRepeater(objWrapper){
		...
		//init button
		objButtonAdd.click(repeaterAddItem);
	...
	this.initImageChooser = function(objImageSettings){
		...
		objImageSettings.find(".unite-setting-image-preview").click(onChooseImageClick);
