...
define("BLOXBUILDER_TEXTDOMAIN","blox_builder");
...
class UniteProviderFunctionsUC{
	...
	*/
	...
	public static function putFooterTextLine(){
		?>
			&copy; <?php _e("All rights reserved",BLOXBUILDER_TEXTDOMAIN)?>, <a href="http://codecanyon.net/user/bloxthemes" target="_blank">Blox Themes</a>. &nbsp;&nbsp;
		<?php
	}
	...
	private static function a__________OPTIONS_________(){}
	...
	public static function putUpdatePluginHtml(){
		...
		<div class="uc-update-plugin-wrapper">
			<a id="uc_button_update_plugin" class="unite-button-primary" href="javascript:void(0)" ><?php _e("Update Plugin", BLOXBUILDER_TEXTDOMAIN)?></a>
		</div>
		
		<!-- dialog update -->
		
		<div id="dialog_update_plugin" title="<?php _e("Update Blox Page Builder Plugin",BLOXBUILDER_TEXTDOMAIN)?>" style="display:none;">	
			
			<div class="unite-dialog-title"><?php _e("Update Blox Page Builder Plugin",BLOXBUILDER_TEXTDOMAIN)?>:</div>	
			
			<div class="unite-dialog-desc">
				<?php _e("To update the plugin please select the plugin install package.",BLOXBUILDER_TEXTDOMAIN) ?>		
			<br>
		
			<?php _e("The files will be overwriten", BLOXBUILDER_TEXTDOMAIN)?>
		
			<br> <?php _e("File example: blox-page-builder-builder1.x.x.zip",BLOXBUILDER_TEXTDOMAIN)?>	
				
				<br>
				<br>
				<?php _e("Post Max Size")?>: <?php echo $postMaxSize?>	
				<br>
				<?php _e("Max Upload Size")?>: <?php echo $maxUploadSize?>
				<br>
				<?php _e("You can change those settings in php.ini or contact your hosting provider")?>
			</div>	
			...
			<form action="<?php echo GlobalsUC::$url_ajax?>" enctype="multipart/form-data" method="post">
				...
				<?php _e("Choose the update file:",BLOXBUILDER_TEXTDOMAIN)?>
				<br><br>
				...
				<input type="submit" class='unite-button-primary' value="<?php _e("Update Plugin",BLOXBUILDER_TEXTDOMAIN)?>">	
			</form>
