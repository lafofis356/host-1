...
class UnlimitedAddonsMigraterUC{
	...
	public static function putHtmlStart(){
		...
		<div class="uc-compatability-message">
			...
			<h1 class='uc-importer-header'>Blox Page Builder</h1>
			...
			<div class="uc-importer-text">
				...
				And thank you for being part of <b>Blox Page Builder</b>.
				
				<br><br><br>
				
				There was some error with WordPress plugin auto upgrade, and not all the files been copied. 
				
				<br><br><br>
				
				Please delete the plugin from plugins list, and then install again. 
				
				<br><br>
				<br><br>
				 
				No worries, all the pages, addons and designs will be keeped.
	...
	private function init(){
		...
		self::addMenuPage('Blox Page Builder', "adminPages", $urlMenuIcon);
