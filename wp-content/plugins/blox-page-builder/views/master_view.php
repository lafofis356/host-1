...
<div id="uc_dialog_version" title="<?php _e("Version Release Log. Current Version: ".BLOXBUILDER_VERSION." ", BLOXBUILDER_TEXTDOMAIN)?>" style="display:none;">
	<div class="unite-dialog-inside">
		<div id="uc_dialog_version_content" class="unite-dialog-version-content">
			<div id="uc_dialog_loader" class="loader_text"><?php _e("Loading...", BLOXBUILDER_TEXTDOMAIN)?></div>
		</div>
	</div>
</div>
...
<div class="unite-plugin-version-line unite-admin <?php echo $bottomLineClass?>">
	...
	<?php _e("Component verson", BLOXBUILDER_TEXTDOMAIN)?> <?php echo BLOXBUILDER_VERSION?>, 
	<a id="uc_version_link" href="javascript:void(0)" class="unite-version-link">
		<?php _e("view change log", BLOXBUILDER_TEXTDOMAIN)?>
	</a>
