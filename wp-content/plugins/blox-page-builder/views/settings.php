...
class UniteCreatorViewGeneralSettings extends UniteCreatorSettingsView{
	...
	protected function drawAdditionalTabs(){
		...
		<a data-contentid="uc_tab_change_log" class="" href="javascript:void(0)" onfocus="this.blur()"> <?php _e("Change Log", BLOXBUILDER_TEXTDOMAIN) ?></a>
	...
	public function __construct(){
		...
		$this->headerTitle = __("General Settings", BLOXBUILDER_TEXTDOMAIN);
