...
class UniteCreatorGridBuilderPanel{
	...
	* validate pane type
	...
	private function putPane($pane, $index){
	    ...
	    $loaderText = __("Loading Settings...", BLOXBUILDER_TEXTDOMAIN);
	    ...
	    ?>
    		<div class="uc-grid-panel-pane uc-pane-<?php echo $name?><?php echo $addClass?>" data-name="<?php echo $name?>" data-title="<?php echo $title?>" <?php echo $addHtml?> <?php echo $style?> >
    			...
    			<div class="uc-grid-panel-pane-child-content">
    				
    				<a class="uc-panel-action-button uc-pane-button-back-toparent unite-button-secondary" data-action="back_to_parent"><?php _e("Go Back", BLOXBUILDER_TEXTDOMAIN)?></a>
	...
	private function putHtmlHead(){
		...
		?>
   		...
   		<div class="uc-grid-panel-head uc-panetype-<?php echo $name?>">
   			<a class="uc-grid-panel-head-edit" title="<?php _e("Edit My Addon", BLOXBUILDER_TEXTDOMAIN)?>" target="_blank" href="javascript:void(0)" ><i class="fa fa-pencil" aria-hidden="true"></i></a>
   			<div class="uc-grid-panel-head-logo" style="display:none"></div>
   			<div class="uc-grid-panel-head-text" ><?php echo $title?></div>
   			
   			<a href="javascript:void(0)" class="uc-grid-panel-icon uc-panel-icon-action uc-panel-icon-copy" data-action="copy" title="<?php _e("Copy Settings", BLOXBUILDER_TEXTDOMAIN)?>"><i class="fa fa-copy" aria-hidden="true"></i></a>
   			<a href="javascript:void(0)" class="uc-grid-panel-icon uc-panel-icon-action uc-panel-icon-paste" data-action="paste" title="<?php _e("Paste Settings", BLOXBUILDER_TEXTDOMAIN)?>"><i class="fa fa-paste" aria-hidden="true"></i></a>
	...
	public function putHtml(){
		...
		?>
		   ...
		   <a href="javascript:void(0)" title="<?php _e("Show Panel", BLOXBUILDER_TEXTDOMAIN)?>" class="uc-grid-panel-show-handle" style="display:none">
		   		<i class="fa fa-window-close" aria-hidden="true"></i>
		   </a>
