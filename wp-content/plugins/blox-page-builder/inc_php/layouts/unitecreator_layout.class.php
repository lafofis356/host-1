...
class UniteCreatorLayoutWork extends UniteElementsBaseUC{
	...
	private function validateName($name){
		...
		$fieldName = $this->objLayoutType->textSingle.__(" Name", BLOXBUILDER_TEXTDOMAIN);
	...
	private function a__________MAPPING___________(){}
	...
	public function getInfoText(){
		...
		$textEmpty = __("empty layout", BLOXBUILDER_TEXTDOMAIN);
		...
		$text = __("layout with",BLOXBUILDER_TEXTDOMAIN)." ". $numRows. " " . __("sections", BLOXBUILDER_TEXTDOMAIN);
	...
	* get background addon name from settings
	...
	private function getErrorMessagePrefix(){
		...
		$prefix = __("Error in ",BLOXBUILDER_TEXTDOMAIN).$title." :";
	...
	private function a__________MODIFY_FOR_SAVE___________(){}
	...
	* modify layout params for save
	...
	private function a__________CREATE_CONTENT___________(){}
