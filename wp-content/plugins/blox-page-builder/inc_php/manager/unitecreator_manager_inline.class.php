...
class UniteCreatorManagerInline extends UniteCreatorManager{
	...
	protected function getMenuSingleItem(){
		...
		$arrMenuItem = array();
		$arrMenuItem["edit_item"] = __("Edit Item",BLOXBUILDER_TEXTDOMAIN);
		$arrMenuItem["remove_items"] = __("Delete",BLOXBUILDER_TEXTDOMAIN);
		$arrMenuItem["duplicate_items"] = __("Duplicate",BLOXBUILDER_TEXTDOMAIN);
	...
	protected function getMenuMulitipleItems(){
		...
		$arrMenuItemMultiple["remove_items"] = __("Delete",BLOXBUILDER_TEXTDOMAIN);
		$arrMenuItemMultiple["duplicate_items"] = __("Duplicate",BLOXBUILDER_TEXTDOMAIN);
	...
	protected function getMenuField(){
		$arrMenuField = array();
		$arrMenuField["add_item"] = __("Add Item",BLOXBUILDER_TEXTDOMAIN);
	...
	protected function putItemsButtons(){
		...
		switch($itemType){
			...
			?>
 				<a data-action="add_item" type="button" class="<?php echo $buttonClass?>"><?php _e("Add Item",BLOXBUILDER_TEXTDOMAIN)?></a>
			<?php 
			break;
			case UniteCreatorAddon::ITEMS_TYPE_IMAGE:
			?>
 				<a data-action="add_images" type="button" class="<?php echo $buttonClass?>"><?php _e("Add Images",BLOXBUILDER_TEXTDOMAIN)?></a>
			<?php 
			break;
			case UniteCreatorAddon::ITEMS_TYPE_FORM:
				?>
 				<a data-action="add_form_item" type="button" class="<?php echo $buttonClass?>"><?php _e("Add Form Item",BLOXBUILDER_TEXTDOMAIN)?></a>
 				<?php
			break;
		}
		...
		?>
	 		...
	 		<a data-action="duplicate_items" type="button" class="unite-button-secondary button-disabled uc-button-item"><?php _e("Duplicate",BLOXBUILDER_TEXTDOMAIN)?></a>
	 		<a data-action="remove_items" type="button" class="unite-button-secondary button-disabled uc-button-item"><?php _e("Delete",BLOXBUILDER_TEXTDOMAIN)?></a>
	 		<a data-action="edit_item" type="button" class="unite-button-secondary button-disabled uc-button-item uc-single-item"><?php _e("Edit Item",BLOXBUILDER_TEXTDOMAIN)?> </a>
		<?php 
	}
	...
	private function putAddEditDialog(){
		...
		?>
			<div title="<?php _e("Edit Item",BLOXBUILDER_TEXTDOMAIN)?>" class="uc-dialog-edit-item" style="display:none">
				<div class="uc-item-config-settings" autofocus="true" <?php echo $addHtml?>>
					...
					<?php else:	 //load by ajax?>
						...
						<div class="unite-dialog-loader-wrapper">
							<div class="unite-dialog-loader"><?php _e("Loading Settings", BLOXBUILDER_TEXTDOMAIN)?>...</div>
						</div>
