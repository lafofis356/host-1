...
class UniteCreatorManager{
	...
	protected function getMenuSingleItem(){
		...
		$arrMenuItem = array();
		$arrMenuItem["no_action"] = __("No Action",BLOXBUILDER_TEXTDOMAIN);
	...
	protected function getMenuField(){
		...
		$arrMenuField = array();
		$arrMenuField["no_action"] = __("No Action",BLOXBUILDER_TEXTDOMAIN);
	...
	protected function getNoItemsText(){
		...
		$text = __("No Items", BLOXBUILDER_TEXTDOMAIN);
			...
			<div id="categories_wrapper" class="categories_wrapper unselectable">
				...
				<?php if($this->enableCatsActions == true):?>
			 	...
			 	<div class="manager-cats-buttons">
			 		...
			 		<a id="button_add_category" data-action="add_category" type="button" class="unite-button-secondary uc-cat-action-button"><?php _e("Add New Category",BLOXBUILDER_TEXTDOMAIN)?></a>
			 		
				 		<?php if($showAllButtons == true):?>
				 		<a id="button_remove_category" data-action="delete_category" type="button" class="unite-button-secondary button-disabled uc-cat-action-button"><?php _e("Delete",BLOXBUILDER_TEXTDOMAIN)?></a>
				 		<a id="button_edit_category" data-action="edit_category" type="button" class="unite-button-secondary button-disabled uc-cat-action-button"><?php _e("Edit",BLOXBUILDER_TEXTDOMAIN)?></a>
				 		<?php endif?>
			 	</div>
	...
	protected function putDialogEditCategory(){
		?>
			<div id="uc_dialog_edit_category"  title="<?php _e("Edit Category",BLOXBUILDER_TEXTDOMAIN)?>" style="display:none;" >
				
				<div class="unite-dialog-top"></div>
					
					<?php _e("Category ID", BLOXBUILDER_TEXTDOMAIN)?>: <b><span id="span_catdialog_id"></span></b>
					
					<br><br>
					
					<?php _e("Edit Title", BLOXBUILDER_TEXTDOMAIN)?>:
	...
	protected function putDialogAddCategory(){
		?>
			...
			<div id="uc_dialog_add_category"  title="<?php _e("Add New Category",BLOXBUILDER_TEXTDOMAIN)?>" style="display:none;" class="unite-inputs">
			
				<div class="unite-dialog-top"></div>
				<div class="unite-inputs-label"><?php _e("Enter Category Name", BLOXBUILDER_TEXTDOMAIN)?></div>
			
				<input id="uc_dialog_add_category_catname" type="text" class="unite-input-regular" value="">
				
			<?php 
				$prefix = "uc_dialog_add_category";
				$buttonTitle = __("Create Category", BLOXBUILDER_TEXTDOMAIN);
				$loaderTitle = __("Adding Category...", BLOXBUILDER_TEXTDOMAIN);
				$successTitle = __("Category Added", BLOXBUILDER_TEXTDOMAIN);
				HelperHtmlUC::putDialogActions($prefix, $buttonTitle, $loaderTitle, $successTitle);
			?>			
	...
	protected function putDialogDeleteCategory(){
		?>
			<div id="uc_dialog_delete_category"  title="<?php _e("Delete Category",BLOXBUILDER_TEXTDOMAIN)?>" style="display:none;" class="unite-inputs">
			...
			<?php 
				...
				$buttonTitle = __("Delete Category", BLOXBUILDER_TEXTDOMAIN);
				$loaderTitle = __("Deleting Category...", BLOXBUILDER_TEXTDOMAIN);
				$successTitle = __("Category and it's addons Deleted", BLOXBUILDER_TEXTDOMAIN);
				HelperHtmlUC::putDialogActions($prefix, $buttonTitle, $loaderTitle, $successTitle);
			?>			
	...
	protected function getMenuCategory(){
		...
		$arrMenuCat = array();
		$arrMenuCat["no_action"] = __("No Action",BLOXBUILDER_TEXTDOMAIN);
	...
	private function putMenuCatField(){
		...
		$arrMenuCatField["add_category"] = __("Add Category",BLOXBUILDER_TEXTDOMAIN);
		...
		?>
							...
							<div class="status_operations">
								...
								<div id="item_operations_wrapper" class="item_operations_wrapper unite-disabled">
									...
									<?php _e("Move To", BLOXBUILDER_TEXTDOMAIN)?>
	...
	private function putMenuCopyMove(){
		?>
			<ul id="menu_copymove" class="unite-context-menu" style="display:none">
				<li>
					<a href="javascript:void(0)" data-operation="copymove_move"><?php _e("Move Here",BLOXBUILDER_TEXTDOMAIN)?></a>
				</li>
			</ul>
		<?php
	}
	...
	protected function getMenuMulitipleItems(){
		...
		$arrMenuItemMultiple["no_action"] = __("No Action",BLOXBUILDER_TEXTDOMAIN);
	...
	* put scripts according manager type
	...
	public function init($type = ""){
		...
		$this->itemsLoaderText = __("Getting Items", BLOXBUILDER_TEXTDOMAIN);
		$this->textItemsSelected = __("items selected",BLOXBUILDER_TEXTDOMAIN);
