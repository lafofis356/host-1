	...
	class HelperHtmlUC extends UniteHelperBaseUC{
		...
		public static function getHTMLSelect($arr,$default="",$htmlParams="",$assoc = false, $addData = null, $addDataText = null){
			...
			if($addData == "not_chosen"){
				...
				if(empty($itemText))
					$itemText = "[".__("not chosen", BLOXBUILDER_TEXTDOMAIN)."]";
		...
		public static function getTableAddonsRow($addonID, $title){
			...
			$html.= "	<td>\n";
			$html.= " 	  <a href='{$editLink}' class='unite-button-secondary float_left mleft_15'>". __("Edit",BLOXBUILDER_TEXTDOMAIN) . "</a>\n";
			$html.= "		<a href='javascript:void(0)' data-addonid='{$addonID}' class='uc-button-delete unite-button-secondary float_left mleft_15'>".__("Delete",BLOXBUILDER_TEXTDOMAIN)."</a>";
			$html.= "		<span class='loader_text uc-loader-delete mleft_10' style='display:none'>" . __("Deleting", BLOXBUILDER_TEXTDOMAIN) . "</span>";
			$html.= "		<a href='javascript:void(0)' data-addonid='{$addonID}' class='uc-button-duplicate unite-button-secondary float_left mleft_15'>" . __("Duplicate",BLOXBUILDER_TEXTDOMAIN)."</a>\n";
			$html.= "		<span class='loader_text uc-loader-duplicate mleft_10' style='display:none'>" . __("Duplicating", BLOXBUILDER_TEXTDOMAIN) . "</span>";
			$html.= "		<a href='javascript:void(0)' data-addonid='{$addonID}' data-title='{$htmlTitle}' class='uc-button-savelibrary unite-button-secondary float_left mleft_15'>" . __("Save To Library",BLOXBUILDER_TEXTDOMAIN)."</a>\n";
			$html.= "		<span class='loader_text uc-loader-save mleft_10' style='display:none'>" . __("Saving to library", BLOXBUILDER_TEXTDOMAIN) . "</span>";
			$html.= "	</td>\n";
			$html.= "	</tr>\n";
		...
		public static function putDialogControlFieldsNotice(){
			?>
				...
				<div class="unite-inputs-label unite-italic">
					* <?php _e("only dropdown and radio boolean field types are used for conditional inputs", BLOXBUILDER_TEXTDOMAIN)?>.
				</div>
