...
defined('BLOXBUILDER_INC') or die('Restricted access');
	...
	class UniteSettingsAdvancedUC extends UniteSettingsUC{
		...
		public function updateSelectToAlignHor($name, $default = null){
			...
			$arrItems = array(
					"left"=>__("Left",BLOXBUILDER_TEXTDOMAIN),
					"center"=>__("Center", BLOXBUILDER_TEXTDOMAIN),
					"right"=>__("Right", BLOXBUILDER_TEXTDOMAIN)
			);
		...
		public function updateSelectToAlignVert($name, $default = null){
			...
			$arrItems = array(
					"top"=>__("Top",BLOXBUILDER_TEXTDOMAIN),
					"middle"=>__("Middle", BLOXBUILDER_TEXTDOMAIN),
					"bottom"=>__("Bottom", BLOXBUILDER_TEXTDOMAIN)
			);
			...
			foreach($arrOptions as $text=>$option){
				...
				switch($option){
					case "custom":
						...
						$this->addTextBox($name."_title", "", __("&nbsp;Title",BLOXBUILDER_TEXTDOMAIN), $params);
						
						$params = array(
								UniteSettingsUC::PARAM_CLASSADD=>"unite-content-intro");
						
						$this->addTextArea($name."_intro", "", __("&nbsp;Custom Intro",BLOXBUILDER_TEXTDOMAIN), $params);
						*/
						...
						$this->addEditor($name."_content", $value, __("&nbsp;Custom Content",BLOXBUILDER_TEXTDOMAIN), $params);
						
						/*
						$params = array(
								UniteSettingsUC::PARAM_CLASSADD=>"unite-content-link");
						
						$this->addTextBox($name."_link", "", __("&nbsp;Link",BLOXBUILDER_TEXTDOMAIN), $params);
						*/
