...
defined('BLOXBUILDER_INC') or die('Restricted access');
	...
	class UniteCreatorDB{
		...
		public function fetchSingle($tableName,$where="",$orderField="",$groupByField="",$sqlAddon=""){
			...
			if(empty($errorEmpty)){
				$tableTitle = UniteFunctionsUC::getVal(self::$arrTableTitles, $tableName, __("Record", BLOXBUILDER_TEXTDOMAIN));
				
				$errorEmpty = $tableTitle." ".__("not found", BLOXBUILDER_TEXTDOMAIN);
			}
