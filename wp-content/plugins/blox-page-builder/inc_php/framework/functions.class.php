...
defined('BLOXBUILDER_INC') or die('Restricted access');
	...
	class UniteFunctionsUC{
		...
		public static function getArrSanitizeTypes(){
			...
			$arrSanitize = array();
			$arrSanitize[self::SANITIZE_ID] = __("Sanitize ID", BLOXBUILDER_TEXTDOMAIN);
			$arrSanitize[self::SANITIZE_KEY] = __("Sanitize KEY", BLOXBUILDER_TEXTDOMAIN);
			$arrSanitize[self::SANITIZE_TEXT_FIELD] = __("Sanitize Text Field", BLOXBUILDER_TEXTDOMAIN);
			$arrSanitize[self::SANITIZE_NOTHING] = __("No Sanitize (not recomended)", BLOXBUILDER_TEXTDOMAIN);
		...
		public static function validateEmail($email, $fieldName="email"){
			...
			self::throwError(__("The $fieldName is not valid", BLOXBUILDER_TEXTDOMAIN));
		...
		public static function z______________SESSIONS_____________(){}
