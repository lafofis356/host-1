		...
		?>
			<div id="attr_wrapper_<?php echo $this->type ?>" class="uc-attr-wrapper" data-type="<?php echo $this->type?>" <?php echo $style?> >
				...
				<table class="uc-table-params unite_table_items">
					<thead>
						<tr>
							...
							<th width="100px">
								<?php _e("Type", BLOXBUILDER_TEXTDOMAIN)?>
							</th>
							<th width="270px">
								<?php _e("Param", BLOXBUILDER_TEXTDOMAIN)?>
							</th>
							<th width="200px">
								<?php _e("Operations", BLOXBUILDER_TEXTDOMAIN)?>
							</th>
						</tr>
					</thead>
					<tbody>
				...
				<div class="uc-text-empty-params mbottom_20" style="display:none">
						<?php _e("No Params Found", BLOXBUILDER_TEXTDOMAIN)?>
				</div>
				
				<a class="uc-button-add-param unite-button-secondary" href="javascript:void(0)"><?php _e("Add Attribute", BLOXBUILDER_TEXTDOMAIN);?></a>
				
				<?php if($this->isItemsType):?>
				
				<a class="uc-button-add-imagebase unite-button-secondary mleft_10" href="javascript:void(0)"><?php _e("Add Image Base Fields", BLOXBUILDER_TEXTDOMAIN);?></a>
